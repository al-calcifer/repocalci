...
!imprimindo a cadeia 
	!primeiro hidrogênio
	  ...
	  if (Lc+8 .lt. az) then	
      Write(12,114) nat+1,1, 0.00,0.00,0.00-0.5*Lc, 2
      Write(13,*) 0.00,0.00,0.00-0.5*Lc, 2

	!cadeia de carbono

	 	Do i=1,Ncarbon
            zc=dhc+(i-1)*dcc-0.5*Lc
			Write(12,114) i+nat+1,6, 0.00,0.00,zc, 1
            Write(13,*) 0.00,0.00,zc, 1
		Enddo

	!último hidrogênio
	  
	  	Write(12,114) nat+Ncarbon+2,1, 0.00,0.00,Lc-0.5*Lc, 1
	  	Write(13,*) 0.00,0.00,Lc-0.5*Lc, 2
