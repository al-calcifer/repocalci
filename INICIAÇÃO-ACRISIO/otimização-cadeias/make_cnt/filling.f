...
c      Write(6,116) 'Density=', Nmedia/(P1-P2)
 ...
 113  Format (3E20.11)
  ...
  150 write(*,*) 'Número de átomos de carbono na cadeia:'
      ...
      write (13,*) 'ptm'
      write (13,117) 2+Ncarbon,r,s,t
 117  Format(4I6)
      write (13,118) t1,t2
 118  Format (2E20.11)
      write (13,119) ax,ay,az
 119  Format (3E20.11)
...
!	  Write(13,114) 1,1, 0.00,0.00,0.00-0.5*Lc, 1

	!cadeia de carbono

	 	Do i=1,Ncarbon
            zc=dhc+(i-1)*dcc-0.5*Lc
			Write(13,114) i+1,6, 0.00,0.00,zc, 1
!			Write(13,*) 'C', 0.00,0.00,dhc+(i-1)*dcc
		Enddo 

	!último hidrogênio
	  
!	  	Write(13,114) Ncarbon+2,1, 0.00,0.00,Lc-0.5*Lc, 1
!	  else
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      Do iwrite=1,4
        Do i=1,Ncarbon+2
		   ...
		   Write(13,115) i, 0.000, 0.000, 0.000
