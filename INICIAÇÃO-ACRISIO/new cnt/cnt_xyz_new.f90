...
!!
  	...
  	write(26,*) 'H', latt1(1), latt1(2), (r2*Ncells/3)-0.5
  	write(11,*) 'H', latt1(1), latt1(2), (r2*Ncells/3)-0.5
	write(*,*) 'H', latt1(1), latt1(2), (r2*Ncells/3)-0.5
...
!!!   write(36,*) natom
 	...
 	write(26,*) 'C', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnc-0.5
	write(11,*) 'C', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnc-0.5
	write(*,*) 'C', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnc-0.5

	end do


	write(26,*) 'H', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnh-0.5
	write(11,*) 'H', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnh-0.5
	write(*,*) 'H', carbonaxis1, carbonaxis2, (r2*Ncells/3)+ptnh-0.5
