...
!imprimindo a cadeia 
	!primeiro hidrogênio
	  ...
	  if (Lc+8 .lt. az) then	
      Write(12,114) nat+Nmedia+1,1, 0.00,0.00,0.00-0.5*Lc, 1
!	  Write(13,*) 'H', 0.00,0.00,0.00
	...
	!cadeia de carbono
	 	...
	 	Do i=1,Ncarbon
			...
			Write(12,114) nat+Nmedia+1+i,6, 0.00,0.00,zc, 1
		Enddo

	!último hidrogênio
	  
	  	Write(12,114) nat+Nmedia+Ncarbon+2,1, 0.00,0.00,Lc-0.5*Lc, 1
