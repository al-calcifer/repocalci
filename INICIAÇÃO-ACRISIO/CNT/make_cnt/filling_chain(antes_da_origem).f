      Integer nat,A,B,C
      Integer r,s,t,Nmedia, Ncarbon, recuo,g(30000)
...
c      Write(6,116) 'Density=', Nmedia/(P1-P2)
      ...
      write (12,*) 'ptm'
      write (12,111) nat+Nmedia+Ncarbon+2,r,s,t
 111  Format(4I6)
      write (12,112) t1,t2
 112  Format (2E20.11)
...
!imprimindo a cadeia 
	!primeiro hidrogênio
	  recuo=(az/4)	
      Write(12,114) nat+Nmedia+1,1, 0.00,0.00,-recuo, 1
!	  Write(13,*) 'H', 0.00,0.00,0.00

	!cadeia de carbono

!	  if (dhc+(Ncarbon-1)*dcc .le. 2*dhc+((Ncarbon-1)*dcc)+5) then
	 	Do i=1,Ncarbon
			Write(12,114) nat+Nmedia+1+i,6, 0.00,0.00,dhc+(i-1)*dcc-recuo, 1
!			Write(13,*) 'C', 0.00,0.00,dhc+(i-1)*dcc
		Enddo
!	  else         
...
!      end if
	...
	!último hidrogênio
	  ...
	  if (Lc+5 .lt. (az/2)) then
	  	Write(12,114) nat+Nmedia+Ncarbon+2,1, 0.00,0.00,Lc-recuo, 1
!		Write(13,*) 'H', 0.00,0.00,Lc
	  else
		write(*,*) 'insira menos átomos de carbono'
		go to 150
	  end if
